...
try {
    ...
    $(document).ready(function () {
        ...
        var paginas = {
            'p1': '<div id="p1">    <div class="global centrar"><br><br>        <div class="inicio centrar-full back-class">            <h1>Landing library</h1>        </div>        <div class="columns is-gapless  is-multiline">            <div class="column is-6-fullhd is-6-desktop  is-12-tablet  is-12-mobile "><br> ' + formulario + '  <br></div>            <div class="column is-6-fullhd is-6-desktop  is-12-tablet  is-12-mobile ">                <div>                    <br>                    <h1 class="hola"> </h1>                    <h2 class="hola2"></h2>                    <ul>                        <li>Páginas sin tener que actualizar</li>                        <li>Elementos como slices o animaciones sólo llamando una función</li>                    </ul> <br>                </div>            </div>        </div>    </div></div>',
            'p2': '<div id="p2"><h1>Este es contáctanos</h1></div>',
            'p3': '<div id="p3"><h1>Este es politicas</h1></div>',
        };
